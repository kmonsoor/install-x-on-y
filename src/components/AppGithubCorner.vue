<template>
    <div>
        <a aria-label="View source on Github" class="github-corner" href="https://github.com/kmonsoor/install-x-on-y">
            <svg aria-hidden="true" height="80" style="fill:#FD6C6C; color:#fff; position: absolute; top: 0; border: 0; right: 0;"
